...
export function SceneEcosystem() {
  return (
    ...
    >
      ...
      */}
      <div 
        className="w-[90vw] h-[80vh] border border-line rounded-2xl overflow-hidden bg-background/80 backdrop-blur-2xl shadow-[0_0_100px_rgba(0,0,0,0.5)] flex flex-col relative"
      ...
      >
        ...
        <div className="h-10 border-b border-line flex items-center px-4 gap-4 bg-surface/50">
           ...
           <div className="text-xs font-mono text-muted-foreground mx-auto">Vichith Studio — project_04.vch</div>
        </div>

        {/* Desktop UI Layout */}
        <div className="flex-1 flex">
           {/* Sidebar */}
           <div className="w-64 border-r border-line p-4 flex flex-col gap-2">
           ...
           <div className="flex-1 relative flex flex-col">
              <div className="flex-1 flex items-center justify-center p-8">
                 <div className="w-full h-full border border-dashed border-line-strong rounded-xl flex items-center justify-center">
                    <span className="eyebrow text-xl">The Finished Work</span>
                 </div>
              </div>
              {/* Timeline */}
              <div className="h-48 border-t border-line p-4 grid gap-2">
           ...
           {/* Right Panel */}
           <div className="w-72 border-l border-line p-4 flex flex-col gap-4">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ transform: "translateZ(200px)" }}>
           <h2 className="text-6xl text-white font-medium drop-shadow-2xl text-center">
