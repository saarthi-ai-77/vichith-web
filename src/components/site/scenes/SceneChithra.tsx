...
export function SceneChithra() {
  ...
  return (
    <div
      ...
      data-z="-4000"
    >
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl flex flex-col items-center justify-center scale-[0.65] sm:scale-[0.8] md:scale-100 preserve-3d pointer-events-none">
        <div className="text-center w-full max-w-3xl mb-16 px-6 md:px-0 pointer-events-auto" style={{ transform: "translateZ(200px)" }}>
        ...
        <div className="relative w-full max-w-4xl min-h-96 md:grid-field md:border-t md:border-b md:border-line flex flex-col md:flex-row items-center justify-between px-6 py-12 md:px-12 md:py-0 preserve-3d pointer-events-auto">
          
          {/* Input Intent */}
          <div className="w-full max-w-[16rem] glass-panel p-6 shadow-float mb-12 md:mb-0" style={{ transform: "translateZ(150px) rotateY(10deg)" }}>
          ...
          <div className="relative w-32 h-32 flex items-center justify-center preserve-3d mb-12 md:mb-0" style={{ transform: "translateZ(50px)" }}>
          ...
          {/* Output Generation */}
          <div className="w-full max-w-[16rem] glass-panel p-6 shadow-float flex flex-col gap-4" style={{ transform: "translateZ(150px) rotateY(-10deg)" }}>
          ...
          <div 
            className="hidden md:block absolute top-1/2 left-[17rem] right-[17rem] h-[2px] -translate-y-1/2 overflow-hidden"
