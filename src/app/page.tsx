  ...
  return (
    <>
      ...
      <section id="hero">
        ...
        <div className="hero-actions reveal reveal-delay-3" style={{ marginBottom: '1.5rem' }}>
        ...
        <div className="reveal reveal-delay-3" style={{ display: 'flex', justifyContent: 'center', marginBottom: '2.5rem' }}>
          <a href="https://www.producthunt.com/products/vichith?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-vichith" target="_blank" rel="noopener noreferrer">
            <img 
              alt="Vichith - Editor for Modern Video Workflows | Product Hunt" 
              width="250" 
              height="54" 
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1178329&theme=dark&t=1782218857989" 
