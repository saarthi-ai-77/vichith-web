        ...
        <div className="steps-wrapper">
          ...
          <div className="guide-step-card">
            ...
            <div className="step-body">
              ...
              <p>Click the download button on the home page or download directly from the link below. The setup installer is distributed as a executable file (`Vichith_Setup_0.5.0.exe`).</p>
              <div style={{ marginTop: '1rem' }}>
                <a href="https://github.com/saarthi-ai-77/vichith-web/releases/download/v0.5.0/Vichith_Setup_0.5.0.exe" className="btn-primary" style={{ padding: '0.5rem 1.25rem', fontSize: '0.875rem' }}>
          ...
          <div className="guide-step-card">
            ...
            <div className="step-body">
              ...
              <p>Locate the downloaded `Vichith_Setup_0.5.0.exe` file on your PC (usually in your Downloads folder) and double-click to run it.</p>
            </div>
          </div>
            ...
            <div className="step-body">
              ...
              <div className="mock-smartscreen">
                ...
                <div className="mock-ss-metadata">
                  <div><strong>App:</strong> Vichith_Setup_0.5.0.exe</div>
