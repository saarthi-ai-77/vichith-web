        ...
        <div className="steps-wrapper">
          ...
          <div className="guide-step-card">
            ...
            <div className="step-body">
              ...
              <p>Locate the downloaded `Vichith_0.5.0_x64-setup.exe` file on your PC (usually in your Downloads folder) and double-click to run it.</p>
            </div>
          </div>
            ...
            <div className="step-body">
              ...
              <div className="mock-smartscreen">
                ...
                <div className="mock-ss-metadata">
                  <div><strong>App:</strong> Vichith_0.5.0_x64-setup.exe</div>
